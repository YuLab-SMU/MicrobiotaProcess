...
#' @export
ggdiffclade.data.frame <- function(taxda, nodedf, factorName, layout="circular", size=0.6, 
...
#' @param feMeanMedian object, featureMeanMedian see also \code{\link[MicrobiotaProcess]{getMeanMedian}}.
...
#' @param coloslist vector, color vector, if the input is phyloseq, you should use this to adjust the color, 
#' not scale_color_manual.
...
#' @export
ggdifftaxbar.featureMeanMedian <- function(feMeanMedian, featurename, class, subclass, xtextsize=3,
