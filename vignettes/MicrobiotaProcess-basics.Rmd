...
```{r, error=FALSE, fig.align="center", fig.height=4.5, fig.width=6, dev = "svg", fig.ext = "svg", eval = capabilities("cairo"), ordanalysis}
...
```{r, fig.align="center", fig.height=5, fig.width=6, dev = "svg", fig.ext = "svg", eval = capabilities("cairo"), error=FALSE, hclustAnalysis}
