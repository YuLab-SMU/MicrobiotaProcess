...
```{r, error=TRUE, fig.align="center", fig.height=3.2, fig.width=7.5, rarefaction}
...
```{r, error=TRUE, fig.width=7.5, fig.height=3.2, fig.align="center", alphaindex}
...
```{r, error=TRUE, fig.align="center", fig.height=4.5, fig.width=7, taxabar}
# relative abundance
...
```{r, error=TRUE, fig.align="center", fig.height=4.5, fig.width=6, ordanalysis}
