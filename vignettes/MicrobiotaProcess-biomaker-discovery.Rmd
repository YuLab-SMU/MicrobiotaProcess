...
```{r, fig.width=7, fig.height=7, fig.align="center", error=FALSE, dev = "svg", fig.ext = "svg", eval = capabilities("cairo"), KosticCRCdiffclade}
...
```{r, fig.width=7, fig.height=7, fig.align="center", error=FALSE, dev = "svg", fig.ext = "svg", eval = capabilities("cairo"), hmpdiffclade}
