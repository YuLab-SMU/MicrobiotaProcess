...
# with tidytree (>=0.3.4.992)
# taxa.tree %>% select(label, LDAupper, LDAmean, LDAlower, Sign_time, pvalue, fdr) %>% dplyr::filter(!is.na(fdr))
#
p1 <- ggtree(
        taxa.tree,
        layout="radial",
